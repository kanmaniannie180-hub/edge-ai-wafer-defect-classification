...
# ================== CONFIG ==================
RAW_ZIP = "malformed_vias.zip"
NPZ_PATH = "carinthia_malformed_vias_50.npz"

CLASS_NAME = "malformed_vias"
...
WORK_DIR = "tmp_malformed_mix"
BASE_OUT = "phase1_malformed_vias_split"
# ============================================
...
def main():
    ...
    # -------- zip each split --------
    for split in ["train", "val", "test"]:
        zip_name = f"malformed_vias_{split}.zip"
    ...
    print("Zips created:")
    print(" - malformed_vias_train.zip")
    print(" - malformed_vias_val.zip")
    print(" - malformed_vias_test.zip")
    print("===================================")
