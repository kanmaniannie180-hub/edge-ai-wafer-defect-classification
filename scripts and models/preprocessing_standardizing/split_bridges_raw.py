...
WORK_DIR = "tmp_bridges_raw"
BASE_OUT = "phase1_bridges_split"
# ============================================
...
def standardize_image(img):
    ...
    # 🔑 conditional normalization (prevents black images)
    if img.max() > 1.0:
        img = img / 255.0
...
def main():
    ...
    print("Zips created:")
    print(" - bridges_train.zip")
    print(" - bridges_val.zip")
    print(" - bridges_test.zip")
    print("===================================")
