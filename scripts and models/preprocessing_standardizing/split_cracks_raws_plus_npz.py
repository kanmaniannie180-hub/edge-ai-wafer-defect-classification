...
# ================== CONFIG ==================
RAW_ZIP = "crack_raws.zip"
NPZ_PATH = "carinthia_cracks_50.npz"
...
WORK_DIR = "tmp_cracks_mix"
BASE_OUT = "phase1_cracks_split"
# ============================================
...
def main():
    ...
    print("Zips created:")
    print(" - cracks_train.zip")
    print(" - cracks_val.zip")
    print(" - cracks_test.zip")
    print("===================================")
