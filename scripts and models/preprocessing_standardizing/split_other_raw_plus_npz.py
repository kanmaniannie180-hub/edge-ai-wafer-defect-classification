...
# ================== CONFIG ==================
RAW_ZIP = "other_raw.zip"
NPZ_PATH = "carinthia_other_4.npz"
...
WORK_DIR = "tmp_other_mix"
BASE_OUT = "phase1_other_split"
# ============================================
...
def main():
    ...
    print("Zips created:")
    print(" - other_train.zip")
    print(" - other_val.zip")
    print(" - other_test.zip")
    print("===================================")
