...
This phase intentionally avoids complex tasks in favor of a well‑scoped, deployment‑aware prototype that aligns with embedded constraints.
...
The model classifies inspection images into exactly 8 non‑overlapping defect categories:
